...
# Pass random seed, set output file directory inside this document
# bioko_island_qsubber_proto.R
#
##
...
h_inf <- here("SpatialUncertainty/Baseline/sim_output", paste0("pfsi_", seed, ".csv"))
...
mosy <-  here("SpatialUncertainty/Baseline/sim_output", paste0("mosy_", seed, ".csv"))
...
# 
# h_inf <- here("SpatialUncertainty/Baseline/sim_output", paste0("pfsi_", 1, ".csv"))
# dt <- fread(h_inf)
# 
...
# 
# h <- melt(dt[areaId %in%  c(220,335,502,1175,2199,2457)],
